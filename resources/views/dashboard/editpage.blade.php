...
@section('content')
<form method="post" action="{{route('updatepage',$page->id)}}">
    @csrf
    @method('PUT')
   
    <div class="mb-3">
        <label for="title" class="form-label">Page Title</label>
        <input type="text" class="form-control bg-dark text-light border-secondary" name="title" placeholder="Enter the post title" value="{{ old('title',$page->title) }}">
        <x-input-error name="title"/>
    </div>

    <div class="mb-3">
        <label for="content" class="form-label">Page Content</label>
        <textarea class="form-control bg-dark text-light border-secondary" name="content" rows="6" placeholder="Write your post content here...">{{ old('content',$page->content) }}</textarea>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control bg-dark text-light border-secondary" id="url" name="url" placeholder="post-slug" value="{{ old('url',$page->url) }}">
